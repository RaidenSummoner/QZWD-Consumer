		...
		<view>
			<view v-for="(item,index) in courses" :key="index" v-if="item.star===1">
				<view class="book" @click="jump">
					...
					<view class="star1">
						<image v-if="item.star===0" class="star2" src="../../static/收藏.png" @click.stop="add1(index)"></image>
						<image v-if="item.star===1" class="star2" src="../../static/收藏1.png" @click.stop="del1(index)"></image>
						<p>{{item.num}}</p>
					</view>
				</view>
				<br>
